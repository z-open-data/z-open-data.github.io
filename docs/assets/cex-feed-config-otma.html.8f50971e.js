...
</code></pre><div class="line-numbers"><span class="line-number">1</span><br></div></div>`,8),b=e("For more details, see the "),m={href:"https://www.ibm.com/docs/en/ims-cex/3.1?topic=events-jcl",target:"_blank",rel:"noopener noreferrer"},u=e("feed JCL"),f=e(" and "),h={href:"https://www.ibm.com/docs/en/ims-cex/3.1?topic=events-fields",target:"_blank",rel:"noopener noreferrer"},x=e("list of feed fields"),S=e(" in the IMS Connect Extensions documentation in IBM Knowledge Center.");function I(_,C){const s=t("ExternalLinkIcon");return o(),l(p,null,[d,n("p",null,[b,n("a",m,[u,a(s)]),f,n("a",h,[x,a(s)]),S])],64)}var N=r(c,[["render",I]]);export{N as default};
