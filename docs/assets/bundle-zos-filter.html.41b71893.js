import{_ as n,c as s}from"./app.39875f72.js";const a={},p=s(`<h1 id="optional-filter-fields" tabindex="-1"><a class="header-anchor" href="#optional-filter-fields" aria-hidden="true">#</a> Optional: Filter fields</h1><p>By default, the OMEGAMON Data Connect component of ODP forwards all data that it receives.</p><p>Optionally, you can specify a filter in the OMEGAMON Data Connect configuration file to forward only specific fields.</p><p>Filters are useful for reducing data volume if you have limited storage capacity.</p><p>However, filters restrict the fields that are available for analysis.</p><p>If you decide that you want to limit the forwarded data to just the fields used by the starter dashboards, add the following filter to the OMEGAMON Data Connect configuration file:</p><div class="custom-container warning"><p class="custom-container-title">WARNING</p><p>This filter corresponds to the <em>current</em> starter dashboards. You might want to create dashboards that use other fields, or extend the samples with other fields. Future samples might require fields that this filter excludes. It is your decision whether to introduce a filter, and how to manage it.</p></div><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">connect</span><span class="token punctuation">:</span>
        ...
        <span class="token key atrule">tables</span><span class="token punctuation">:</span>
          ...
          <span class="token key atrule">lpclust</span><span class="token punctuation">:</span>
            ...
            <span class="token key atrule">fields</span><span class="token punctuation">:</span>
              ...
              <span class="token punctuation">-</span> sysplex_name
              <span class="token punctuation">-</span> smf_id
          <span class="token key atrule">m5zcxcont</span><span class="token punctuation">:</span>
            <span class="token key atrule">enabled</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
            <span class="token key atrule">fields</span><span class="token punctuation">:</span>
              <span class="token punctuation">-</span> managed_system
              <span class="token punctuation">-</span> job_name
              ...
              <span class="token punctuation">-</span> cpu_user
              <span class="token punctuation">-</span> cpu_system
              <span class="token punctuation">-</span> io_bytes_read
              <span class="token punctuation">-</span> io_bytes_total
              <span class="token punctuation">-</span> io_bytes_write
              <span class="token punctuation">-</span> io_calls_read
              <span class="token punctuation">-</span> io_calls_total
              <span class="token punctuation">-</span> io_calls_write
              <span class="token punctuation">-</span> memory_usage
              <span class="token punctuation">-</span> memory_max_usage
              <span class="token punctuation">-</span> memory_cache
              <span class="token punctuation">-</span> memory_rss
              <span class="token punctuation">-</span> memory_swap
              <span class="token punctuation">-</span> memory_mapped_file
              <span class="token punctuation">-</span> memory_working_set
              <span class="token punctuation">-</span> memory_failcnt
              <span class="token punctuation">-</span> received_bytes
              <span class="token punctuation">-</span> received_packets
              <span class="token punctuation">-</span> received_errors
              <span class="token punctuation">-</span> received_dropped
              <span class="token punctuation">-</span> transmitted_bytes
              <span class="token punctuation">-</span> transmitted_packets
              <span class="token punctuation">-</span> transmitted_errors
              <span class="token punctuation">-</span> transmitted_dropped
              <span class="token punctuation">-</span> sysplex_name
              <span class="token punctuation">-</span> smf_id
          <span class="token key atrule">m5zcxins</span><span class="token punctuation">:</span>
            <span class="token key atrule">enabled</span><span class="token punctuation">:</span> <span class="token boolean important">true</span>
            <span class="token key atrule">fields</span><span class="token punctuation">:</span>
              <span class="token punctuation">-</span> managed_system
              <span class="token punctuation">-</span> job_name
              <span class="token punctuation">-</span> containers
              <span class="token punctuation">-</span> cpu_total
              <span class="token punctuation">-</span> cpu_user
              <span class="token punctuation">-</span> cpu_system
              <span class="token punctuation">-</span> io_bytes_read
