import{_ as n,c as a}from"./app.5bc778db.js";const s={},e=a(`<h1 id="update-the-odp-collection-configuration" tabindex="-1"><a class="header-anchor" href="#update-the-odp-collection-configuration" aria-hidden="true">#</a> Update the ODP collection configuration</h1><ol><li>On z/OS, edit the ODP collection configuration member <code>RKANPARU(KAYOPEN)</code> to specify the attribute groups required by the dashboard:</li></ol><div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">collections</span><span class="token punctuation">:</span>
