import{_ as t,o as p,c as o,a as n,d as a,t as l,F as c,e as s}from"./app.eca5dfe0.js";const r={},u=n("h1",{id:"update-the-odp-collection-configuration",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#update-the-odp-collection-configuration","aria-hidden":"true"},"#"),a(" Update the ODP collection configuration")],-1),i=a("On z/OS, edit the ODP collection configuration member "),d=n("code",null,"RKANPARU(KAYOPEN)",-1),k=s(`<div class="language-yaml ext-yml line-numbers-mode"><pre class="language-yaml"><code><span class="token key atrule">collections</span><span class="token punctuation">:</span>
